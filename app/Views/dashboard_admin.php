...
/* CSS untuk tombol edit dan hapus */
.open-buttonn {
  background-color: #4CAF50;
  color: white;
  padding: 6px 12px;
...
<header>
  ...
  <div class="container">
    <div class="intro">
      <p class="title">Selamat datang, Administrator</p>
    ...
    <div class="parallax">
      <div class="tentang">
        ...
        <br>
        <p class="description">Hai Administrator, Berikut Data Tempat Wisata Yang Kamu Kelola</p>
        <div class="mt-10">
          <button class="btn-cta"> <a href="https://kemenparekraf.go.id/direktori/Dinas-Pariwisata">Dinas Terkait</a></button>
        </div>
      </div>
      
      <table class="table" id="INFORMATIKA">
  <tr>
    <th>ID</th>
    <th>Nama Tempat</th>
    <th>Deskripsi</th>
    <th>Gambar</th>
    <th>Di Upload Pada Tanggal</th>
    <th>Aksi</th>
  </tr>
  <?php foreach ($places as $place) : ?>
    <tr>
      ...
      <td><img src="/uploads/<?= $place['image'] ?>" width="100"></td>
      <td><?= $place['created_at'] ?></td>
      <td>
        <a href="/admin/places/edit/<?= $place['id'] ?>"><button class="open-buttonn">Edit</button></a>
        <a href="/admin/places/delete/<?= $place['id'] ?>"><button class="open-buttonn">Hapus</button></a>
      </td>
    </tr>
  <?php endforeach; ?>
</table>
    ...
    <a href="/admin/places/create"><button class="open-button"> Tambah Tempat wisata</button></a>
    <br>
    <a href="/userdashboard"><button class="open-button"> View User Dashboard </button></a>
    <br>
    <a href="/logout"><button class="open-button"> Logout </button></a>
