...
<body>
  <header>
    ...
    <nav>
      <ul>
        <li><a href="#INFORMATIKA">Edit Tempat Wisata</a></li>
  ...
  <div class="container">
    <div class="intro">
	  ...
	  <video autoplay loop muted playsinline>
		<source src="../assets/w4.mp4" type="video/mp4" alt="yohan bachtiar" class="img-foto" />
	  </video>
    </div>
  </div>
  ...
  <div class="parallaxlogin">
    <div class="tentang">
	<div class="mt-10">
      <p class="description">Hallo, Pastikan Anda Mengubah Data Dengan Benar!</p>
	...
	<div class="intro">
	<h1 class="title">UBAH DATA TEMPAT WISATA</h1>
</div>
    ...
    <form action="/admin/places/update/<?= $place['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <br>
        <textarea name="description" required><?= $place['description'] ?></textarea>
        <br>
